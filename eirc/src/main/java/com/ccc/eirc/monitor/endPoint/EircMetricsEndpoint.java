 ...
 */
@EircEndPoint
public class EircMetricsEndpoint {

    private final MeterRegistry registry;

    public EircMetricsEndpoint(MeterRegistry registry) {
    ...
    @ReadOperation
    public EircMetricResponse metric(@Selector String requiredMetricName, @Nullable List<String> tag) {
        ...
        if (meters.isEmpty()) {
            ...
            return new EircMetricResponse(requiredMetricName, meterId.getDescription(), meterId.getBaseUnit(), this.asList(samples, Sample::new), this.asList(availableTags, AvailableTag::new));
        }
    ...
    public static final class EircMetricResponse {
        ...
        EircMetricResponse(String name, String description, String baseUnit, List<Sample> measurements, List<AvailableTag> availableTags) {
            this.name = name;
